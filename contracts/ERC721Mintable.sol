...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _ownerAddress, "Only the owner can call this function");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Cannot transfer ownership to the same address");
...
contract Pausable is Ownable {
    ...
    function setPaused(bool state) public onlyOwner {
        require(_paused != state, "The contract is already in this state");
        if (state) {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address _ownerAddress) public view returns (uint256) {
        ...
        return _ownedTokensCount[_ownerAddress].current();
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != msg.sender, "Cannot approve the same token to the same owner");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(this.ownerOf(tokenId) == msg.sender, "Only the owner or operator can approve");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Not authorized to transfer");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        _ownedTokensIndex[tokenId] = _ownedTokens.length;
        _ownedTokens.push(tokenId);
    }
